"""Working Nomads — remote jobs API/RSS.
Fetches from sysadmin/devops category which includes security roles.
All results pass through the cybersecurity keyword filter in config.
"""
...
def fetch_workingnomads() -> list[Job]:
    ...
    for item in data:
        ...
        # Include dev, sysadmin, devops — security roles appear in these
