...
def _search_urls(query: str) -> list[tuple[str, str]]:
    # The legacy HTML search fallback was removed: it returns persistent HTTP 403
    # in production and wastes the LinkedIn budget.
    for search_fn in (_search_via_google_cse, _search_via_serpapi):
