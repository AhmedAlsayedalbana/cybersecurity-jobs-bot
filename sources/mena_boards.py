...
def fetch_mena_boards() -> list[Job]:
    """MENA Boards: original sub-sources are dead as of 2026-05.

    Replaced by direct integrations in egypt_direct.py and gulf_direct.py.
    """
    log.info("MENA Boards: all sub-sources dead - skipped")
    return []
