...
class _ProxyPool:
    ...
    COOLDOWN_429  = 600   # 10 min
    COOLDOWN_403  = 1800  # 30 min
    COOLDOWN_ERR  = 120   # 2 min
    ...
    def __init__(self):
        ...
        self._scores:  dict[str, float] = {p: 50.0 for p in self._proxies}
    ...
    def ban(self, proxy_url: str, reason: str = "429"):
        with self._lock:
            ...
            self._scores[proxy_url] = max(0.0, self._scores.get(proxy_url, 50.0) - penalty)
