...
_GREENHOUSE_CYBERSEC: list[BoardEntry] = [
    ...
    # Former Lever → now Greenhouse (confirmed):
    BoardEntry("rapid7",           "Rapid7"),
    BoardEntry("tenableio",        "Tenable"),
    BoardEntry("qualys",           "Qualys"),
    BoardEntry("illumio",          "Illumio"),
    BoardEntry("intezer",          "Intezer"),
]
