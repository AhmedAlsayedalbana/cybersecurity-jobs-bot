...
def are_duplicate_jobs(a: Any, b: Any, *, threshold: float = 0.72) -> bool:
    """Return True only for the same canonical posting URL.

    Title, company, location, and fingerprints are descriptive metadata, not
    job identity. They must never merge distinct requisitions.
    """
