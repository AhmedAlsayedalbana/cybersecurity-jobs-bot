...
def hard_reject_reason(job: Any) -> str | None:
    ...
    # ERP administration is an application-operations role. Even a vendor
    # description with IAM or cloud product terminology must not turn it into
    # a cybersecurity vacancy.
    if has_any(["netsuite administrator", "netsuite admin"], title):
        return "reject_business_application_admin"
