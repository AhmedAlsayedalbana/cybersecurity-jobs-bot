...
def _build_prompt(job: Any) -> str:
    return (
        "Classify whether this job is primarily a cybersecurity role for a "
        "technical cybersecurity jobs bot focused on Egypt, Saudi Arabia, UAE, "
        "and the Arab world. Reject sales, account management, customer success, "
        "generic IT support, physical security, credit/business risk, and generic "
        "solutions roles. Allow presales/consulting only when the role is clearly "
        "technical cybersecurity architecture/consulting. Choose one role_key from: "
        "soc, blue_team, threat_intel, incident_response, dfir, malware, "
        "detection_engineering, pentest, appsec, product_security, devsecops, "
        "cloudsec, networksec, ot_ics, grc, risk_management, compliance, audit, "
        "iam, pam, vulnerability_management, security_architecture, "
        "security_engineering, security_automation, technical_security_consulting, "
        "security_internship, none. "
        'Return only JSON: {"is_cybersecurity": true|false, "role_key": "string", '
        '"commercial_scope": "technical|commercial|none", '
        '"reject_reason": "string", "confidence": 0.0}.\n\n'
