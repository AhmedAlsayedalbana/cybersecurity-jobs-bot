...
DOMAIN_PATTERNS: dict[str, list[str]] = {
    ...
    "soc": [
        ...
        "security operations engineer", "security operation engineer",
    ...
    "networksec": [
        ...
        "network security backoffice", "network security back office",
    ...
    "seceng": [
        ...
        "iam engineer", "identity security engineer", "it security specialist",
        "identity and access", "identity access management",
        "identity and access management", "identity and access management engineer",
        "privileged access management", "access management", "pam engineer",
        "ping identity", "okta", "okta engineer",
        ...
        "security operations engineer", "security operation engineer",  # engineering focus (not SOC analyst)
...
GENERIC_TECH_REJECTS: list[str] = [
    # Business-application administration is not cybersecurity merely because
    # an ERP product description mentions roles or access.
...
CYBER_TITLE_OVERRIDE_PATTERNS: list[str] = [
    ...
    "it security", "it security specialist", "information security", "identity and access",
    "identity access management", "access management", "privileged access", "pam", "ping identity", "okta",
    "sase", "ztna", "zero trust", "endpoint security", "dns security",
